...
const { kitsStatusesEnum, kitsMessagesEnum } = cscServices.constants.kit;
const {getCommunicationServiceInstance} = cscServices.CommunicationService;


class MakeKitAvailableController extends WebcController {
...
export default MakeKitAvailableController;
