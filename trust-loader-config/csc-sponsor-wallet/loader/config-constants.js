let LOADER_GLOBALS = {
  ...
  LABELS_DICTIONARY: {
    ...
    APP_DESCRIPTION: 'The SPONSOR application for CSC use case',
  ...
  <h1 class="display-6">Welcome to CSC app!</h1>
  <p class="lead">After completing the following wizard you will gain access to CSC app.</p>
