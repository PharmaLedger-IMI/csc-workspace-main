let LOADER_GLOBALS = {
	...
	LABELS_DICTIONARY: {
		APP_NAME: "Demiurge",
		APP_DESCRIPTION: "The \"backend\" application for Clinical Supply Chain",
  ...
  <h1 class="display-6">Welcome to CSC backend app!</h1>
  <p class="lead">After completing the following wizard you will gain access to CSC backend app.</p>
