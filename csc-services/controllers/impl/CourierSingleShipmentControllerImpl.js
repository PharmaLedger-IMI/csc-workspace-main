...
class CourierSingleShipmentControllerImpl extends ViewShipmentBaseController {
  constructor(...props) {
    super(...props);
...
controllersRegistry.registerController('CourierSingleShipmentController', CourierSingleShipmentControllerImpl);
